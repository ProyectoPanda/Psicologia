        ...
        e.each(function() {
          if (!$(this).siblings(".switchery").length) {
            ...
            new Switchery(e, {
              ...
              className:
                "switchery" + ("undefined" != typeof i ? " switchery-" + i : "")
            });
          }
        });
    },
        ...
        $page_content.on("click", ".md-card-fullscreen-deactivate", function() {
          ...
          s.velocity(
            { height: i, width: a },
            {
              ...
              easing: easing_swiftOut,
              begin: function(e) {
                s.find(".md-card-fullscreen-content").velocity(
                  "transition.slideDownOut",
                  { duration: 275, easing: easing_swiftOut }
                );
              },
              complete: function(e) {
                $window.resize(),
      ...
      e.each(function() {
        ...
        e.on("click", ".md-card-overlay-toggler", function(e) {
          e.preventDefault(),
            $(this)
              .closest(".md-card")
              .hasClass("md-card-overlay-active")
              ? $(this)
                  .html("&#xE5D4;")
                  .closest(".md-card")
    ...
    fab_speed_dial: function() {
      $(".md-fab-speed-dial")
        ...
        .on("click", function() {
          ...
          i.hasClass("md-fab-active")
            ? i.removeClass("md-fab-active")
            : i.addClass("md-fab-active"),
            e.velocity(
              { scale: 0 },
              {
                duration: 140,
  ...
  (altair_helpers = {
    ...
    full_screen: function() {
      $("#full_screen_toggle").on("click", function(e) {
        e.preventDefault(), screenfull.toggle();
      });
    }
  }),
  (altair_uikit = {
